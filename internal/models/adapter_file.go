...
type AdapterFile struct {
	...
	Repo          string    `gorm:"column:repo;type:text;not null;uniqueIndex:uq_adapter_files_repo_path,priority:1" json:"repo"`
	Path          string    `gorm:"column:path;type:text;not null;uniqueIndex:uq_adapter_files_repo_path,priority:2" json:"path"`
	Slug          string    `gorm:"column:slug;type:text;not null" json:"slug"`
	Chain         *string   `gorm:"column:chain;type:text" json:"chain,omitempty"`
	DimensionKind *string   `gorm:"column:dimension_kind;type:text" json:"dimension_kind,omitempty"`
